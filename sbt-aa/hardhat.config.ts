 ...
 */
const ENABLED_OPTIMIZER: boolean =
    process.env.ENABLED_OPTIMIZER === "true" ||
    process.env.ENABLED_OPTIMIZER === "1" ||
    ...
    networks: {
        hardhat: {
            ...
            forking: {
                ...
                enabled: process.env.FORKING === "true" || process.env.FORKING === "1"
            } //,
            /*
